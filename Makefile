...
CFLAGS     = -DXP_UNIX -DJS_THREADSAFE -D__LJS_LIBRARY_PATH__="\"${LJS_LIBDIR}\"" -D__LJS_VERSION__="\"${VERSION}\"" $(shell js-config --cflags) -I./src/core -I./src/lib 
...
## CORE ##
CORE_DIR     = src/core
CORE         = ${CORE_DIR}/main.o ${CORE_DIR}/Core.o ${CORE_DIR}/Misc.o ${CORE_DIR}/Interactive.o ${CORE_DIR}/Compile.o
CORE_CFLAGS  = ${CFLAGS}
